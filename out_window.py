...
class Ui_OutputDialog(QDialog):
    def __init__(self):
        ...
        self.Time_Label.setText('%s:%s:%s' % (current_time.hour,current_time.minute,current_time.second))
    ...
    def face_rec_(self, frame, encode_list_known, class_names):
        ...
        :return:
        """
        # attendance gets marked in csv file
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                self.SecLabel.setText("{:.0f}".format(abs(self.ElapseHours.total_seconds()%60)) + 's')
